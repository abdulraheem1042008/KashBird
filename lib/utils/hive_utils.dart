  ...
  static void setCurrentLocation({
    ...
    if (Constant.isDemoModeOn) {
      await Hive.box(HiveKeys.userDetailsBox).putAll({
        HiveKeys.currentLocationCity: "Srinagar",
        HiveKeys.currentLocationState: "Jammu and Kashmir",
        HiveKeys.currentLocationCountry: "India",
        HiveKeys.currentLocationArea: null,
        HiveKeys.currentLocationLatitude: 34.083656,
        HiveKeys.currentLocationLongitude: 74.805621,
      });
    } else {
      await Hive.box(HiveKeys.userDetailsBox).putAll({
